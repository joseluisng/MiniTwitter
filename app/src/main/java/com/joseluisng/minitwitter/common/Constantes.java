package com.joseluisng.minitwitter.common;

public class Constantes {

    public static final String API_MINITWITTER_BASE_URL = "https://minitwitter.com:3001/apiv1/";
    public static final String API_MINITWITTER_FILE_URL = "https://minitwitter.com:3001/apiv1/uploads/photos/";

    // startActivityForResult
    public static final int SELECT_FOTO_GALERY = 1;
